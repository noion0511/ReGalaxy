...
//import com.ssafy.phonesin.common.openvidu.Participant;
...
//import com.ssafy.phonesin.ui.module.homecam.HomeCamActivity;
//
...
//
//
//public class CustomWebSocket extends AsyncTask<HomeCamActivity, Void, Void> implements WebSocketListener {
//
...
//
//    public CustomWebSocket(Session session, AppCompatActivity activity) {
...
//        joinRoomParams.put("sdkVersion", "2.28.0");
...
////        this.createRemoteParticipantVideo(remoteParticipant);
...
//
//    @Override
//    protected Void doInBackground(HomeCamActivity... sessionActivities) {
//        try {
